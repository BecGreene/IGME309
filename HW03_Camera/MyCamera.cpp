...
void MyCamera::CalculateView(void)
{
	...
	// Rotations variables using quaternions
	...
	// Calculate side-to-side and vertical axis
	m_v3Forward = glm::rotate(pitch, m_v3Forward);
	m_v3Forward = glm::rotate(yaw, m_v3Forward);

	// Calculate front-to-back axis 
